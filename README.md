...
- **enableAutomaticEvents:** Отправка автоматических событий SDK. Необязательный параметр, по умолчанию `false`. Если хотите отправлять автоматические события — укажите `true`. Если ваш продукт будет интегрироваться в другой продукт — оставьте положение флага неизменным. [Подробнее](#-системные-события)
...
> **Если хотите отправлять автоматические события — укажите `enableAutomaticEvents: true`.**
>
> ⚠️ **Если ваш продукт будет интегрироваться в другой продукт — оставьте положение флага
> неизменным: при изменении у интегрируемых продуктов сбор аналитики может работать нестабильно.**
